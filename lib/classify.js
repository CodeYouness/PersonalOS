...
const FILE_CAPTURE_TOOL = {
  ...
  description:
    ...
    'one owed to a person), goal or appointment, and the date/time for an appointment.',
  input_schema: {
    type: 'object',
    properties: {
      ...
      title: {
        type: 'string',
        description:
          'A short title. Only meaningful when destination is "task", "people", "goals" or "appointment".',
      },
      date: {
        type: 'string',
        description:
