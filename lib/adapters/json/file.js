 ...
 * the second restores the first -- a destructive factory reset back to the
 * demo content, not an undo of whatever you last did. That property is worth
 * protecting -- nothing here ever writes to the seed.
 *
 ...
 * @property {import('../../domain/types.js').Appointment[]} appointments
...
const REQUIRED_ARRAY_COLLECTIONS = /** @type {const} */ ([
  'tasks', 'appointments', 'people', 'goals', 'links', 'captures', 'memory', 'journal',
