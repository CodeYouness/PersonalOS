 ...
 *
 * @param {import('./domain/types.js').Capture} capture
 * @returns {Promise<import('./domain/types.js').Task | import('./domain/types.js').Goal | import('./domain/types.js').Appointment | null>}
 */
...
/**
 * Whether a task, goal or appointment a capture produced has been touched
 * since creation -- by an edit, or by being finished. A task and a goal
 * spell "finished" differently (`completedAt` vs `done`), and an appointment
 * has no "finished" state at all, so this checks whichever field the record
 ...
 *
 * @param {import('./domain/types.js').Task | import('./domain/types.js').Goal | import('./domain/types.js').Appointment} record
 * @returns {boolean}
 */
