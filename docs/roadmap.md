...
| 12 | **Cards, one per commit** | ~~Today~~, ~~Session~~, Calendar, Habits, CRM, Nutrition, Health, Goals, Finance. **Habits home card done** (#37): tick a check, +1/-1 a counter, ring and streak. The Habits screen itself -- manage list, history heatmap -- is still to come (#35's remaining tickets). |
